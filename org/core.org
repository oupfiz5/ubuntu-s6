...
#+end_src
  ...
  #+begin_src sh :tangle no :dir (concat (file-name-directory (mapconcat 'identity (split-string  buffer-file-name "org/") "")))
    ...
    fossil commit -m "<<commit-message>>" --no-warnings --tag v0.0.1
    # echo ""
...
#+name: commit-message
#+begin_src org :tangle no
  docs: [skip ci] added new section merge to trunk
#+end_src
  ...
  #+RESULTS:
  #+begin_example
  Tue 22 Jun 2021 11:24:06 PM MSK
  Branch is add-shellchecks

  fossil commit -m ...
  New_Version: fed587c616cf7d1c7688b760804d7613998b44a00766d709cfc260ddbb2a226f
  ...
  git update-ref "refs/heads/add-shellchecks" 857cf3f3432a67efb16608695567b0f41f5844f5
