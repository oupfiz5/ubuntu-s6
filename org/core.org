...
#+begin_src org :tangle no
  ci(docker_image_check.sh ): quoted $(pwd) for prevent word splitting
#+end_src
  ...
  #+RESULTS:
  : Sun 20 Jun 2021 02:01:58 PM MSK
  : Branch is add-shellchecks
  :
  : fossil commit -m ...
  : ./org/core.org contains mixed line endings. Use --no-warnings or the "crlf-glob" setting to disable this warning.
