      ...
      steps:
        ...
        - name: Check container
          run: |
            ...
            docker run -d --rm --name="${IMAGE_NAME}" "${REPOSITORY}/${IMAGE_NAME}:${IMAGE_TAG}"
...
#+name: commit-message
#+begin_src org :tangle no
ci(test): updated container tests
#+end_src
  ...
  #+RESULTS:
  #+begin_example
  Sat 03 Jul 2021 12:29:57 AM MSK
  Branch is check-container

  fossil commit -m ...
  New_Version: 3bc187f08af78629ae960fc4d6516d67efd38ba4545c361a46b32690abc25310
  ...
  git update-ref "refs/heads/check-container" e982ee167722abe20bc049dc879273edcf4e7acd
