...
#+name: commit-message
#+begin_src org :tangle no
fix: added missed file .dockleignore
#+end_src
  ...
  #+RESULTS:
  #+begin_example
  Fri 02 Jul 2021 11:49:43 PM MSK
  Branch is check-container

  fossil commit -m ...
  New_Version: 81fcf1519420bba1587fa5742d627787973db56b636e9cc1a0f7ba145e090371

  fossil git export ...
  git fast-import --export-marks=.mirror_state/marks.txt --quiet --done
  1/2      2/2      2 check-ins added to the /home/opsa/Projects/ubuntu-s6/.github-mirroring/ubuntu-s6.git
  git update-ref "refs/heads/check-container" 307eba3511b865567043b27cb8ee96f9c63ee006
