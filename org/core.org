      ...
      steps:
        ...
        - name: Check image (dockle)
          run: |
            cd ${GITHUB_WORKSPACE}/src
            docker image ls
            ./docker_image_check.sh "${REPOSITORY}/${IMAGE_NAME}:${IMAGE_TAG}"

        - name: Check container
          run: |
            cd ${GITHUB_WORKSPACE}/tests
            docker run -d --rm --name="${CONTAINER_NAME}" "${REPOSITORY}/${IMAGE_NAME}:${IMAGE_TAG}"
...
#+name: commit-message
#+begin_src org :tangle no
ci(test): updated on_push pipeline
#+end_src
  ...
  #+RESULTS:
  #+begin_example
  Sat 03 Jul 2021 08:22:27 AM MSK
  Branch is check-container

  fossil commit -m ...
  New_Version: ef0bca038ca37dc828cec2ea75ff263567a9e6d8e47f957b36a7e51be977436d
  ...
  git update-ref "refs/heads/check-container" 8de41b9049d5994eabc6bf5afab75d51f19318a8
